...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($errors)) {
        ...
        $stmt->bind_param("ss", $login_input, $email_val);
        $stmt->execute();
        ...
        if ($user = $result->fetch_assoc()) {
            if (password_verify($password, $user['password'])) {
                ...
                // STORE USERNAME
                $_SESSION['user_name'] = $login_input;
        ...
        $errors['login'] = "Invalid username, email, or password combination.";
        $stmt->close();
    }
}
?>
...
<form method="POST">
    ...
    <input type="text" name="username" value="<?php echo htmlspecialchars($login_input); ?>">
    ...
    <p>Don't have an account? <a href="DETS_signuppage.php">SignUp</a></p>
</form>
